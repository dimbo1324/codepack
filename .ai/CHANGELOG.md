...
бы больше того, что Codex физически читает, и часть правил исчезла бы молча. Владелец
выбрал разделение вместо поднятия лимита.
...
ещё узкий — 29.5 КБ из 30**, поэтому вопрос не закрыт: следующее крупное добавление в
...
**Решил.** Владелец (постановка задачи и выбор разделения модуля вместо поднятия лимита).
