...
def write_refactoring_opportunities_report(
    ...
    for path in iter_project_files(copied_root):
        ...
        if line_count >= 500:
            ...
            suggestions.append(
                "review whether UI, orchestration, and pure helpers can be separated"
            )
        ...
        if "ui" in lower_rel and re.search(
            r"\b(shutil|zipfile|subprocess|os\.walk|threading|Queue)\b", text
        ):
            score += 25
